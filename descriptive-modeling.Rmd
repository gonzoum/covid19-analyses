...
Pending: in this section I'll illustrate the use of the forecast package and the excellent outline book by [Hyndman and Athanasopoulos](https://otexts.com/fpp2/). Set up an example forecast using NY data, including checkresiduals(), as well as hierarchical time series to model state trajectories within the US.
...
#splines, h=# days predicted
h <- 10
fcast <- splinef(nycount.ts,h=h)
autoplot(fcast)
checkresiduals(fcast)

fcast <- splinef(nycount.ts,h=h, lambda="auto")
autoplot(fcast)
checkresiduals(fcast)
