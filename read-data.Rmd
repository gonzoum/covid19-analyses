...
# assumes git has been installed on your machine (e.g., Xcode in mac);
# windows may be different unless unix commands have been installed

# find system operating system
os <- Sys.info()["sysname"]

# move to folder with data and do git pull
if (os == "Darwin") {
  cat(system(
