...
load(file="../data-archive/v.95-111-gbfd5aae-dataworkspace.RData")
@
...
\begin{center}
	\vfill
	\includegraphics[height=3.25in]{../_public/covid19-analyses_files/figure-html/usstates-log-1.png}
\end{center}
\vfill
\end{frame}
