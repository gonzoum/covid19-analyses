...
These notes began as a set of lecture materials to teach advanced quantitative methods and data visualization to graduate statistics in the behavioral sciences at the University of Michigan. The notes are sprinkled with code because one goal is to teach how to conduct these analyses and create the visualizations.  There is another version of these notes that omits much of the code though still retains some of the flavor of how one uses these tools and interprets the output (see the note at the beginning of this page).   If you would like to see the notes from the rest of the graduate statistics course I teach for additional background, visit my [course website](http://www-personal.umich.edu/~gonzo/coursenotes/) that is updated regularly.
