...
plot(exp.pred.ts, stats::lag(exp.pred.ts, 1), cex = .8, col = "blue",
     main = "Phase plot of New York Positive Counts for the Exponential Model",
     xlab="count(t)", ylab="count(t+1)", xlim=c(0,.1),ylim=c(0,.1))
abline(0,1)
```
...
plot(time.series.day.counts, stats::lag(time.series.day.counts, 1), cex = .8, col = "blue",
