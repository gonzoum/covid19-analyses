...
There is a lot that has been written about SIR models and there are many variants. These include the population size increasing/decreasing due to births, migration, and deaths, which end up affecting the overall dynamics of S, I and R proportions (e.g., are there new "susceptible" people recruited into the system? or are people "leaving" the system, say, due to death?).
