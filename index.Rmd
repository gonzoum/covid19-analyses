...
<!-- I decided to produce two versions of these documents. One for the R audience with all the R code and some statistical issues like checking assumptions and one for a broader audience without interest in the R details.  I use echo=longform to select which R chunks to print and asis echo=longform for conditional definition of text. -->
...
I have an [abbreviated version](http://www-personal.umich.edu/~gonzo/covid19/public/) of these notes with limited R code displayed. That version may be easier to follow if you want to see the final results rather than the detailed code presented here.
