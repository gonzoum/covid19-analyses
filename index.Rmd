...
The intended audience is the Psychology 614 graduate statistics course for the behavioral sciences at the University of Michigan. The notes are heavy with code because one goal is to teach how to conduct these analyses and create the visualizations.  Someday I may write a more accessible version of these notes.   If you would like to see the notes from the rest of the graduate statistics course visit my [course website](http://www-personal.umich.edu/~gonzo/coursenotes/) that I update regularly.
