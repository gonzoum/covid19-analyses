...
ggplot(subset(georgia.df.max, day > as.Date("2020/04/1") & maxcount>=250), aes(day,count, group=Admin2, color=Admin2)) + geom_line() + ggtitle("Georgia counties with greater than 250 cases")  + geom_vline(xintercept=as.Date("2020/04/24"), color="red")
...
ggplot(subset(alabama.df.max, day > as.Date("2020/04/1") & maxcount>=250), aes(day,count, group=Admin2, color=Admin2)) + geom_line() + ggtitle("Alabama counties with greater than 250 cases")  + geom_vline(xintercept=as.Date("2020/04/24"), color="red")
