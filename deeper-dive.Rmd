...
out <- nlme(deathIncrease ~ richfu.sir(day.numeric, a, b0,b1), fixed = a+b0+b1~1,
            random =  a+b1~1, data=covid.tracking.new,start=c(a=100, b0=-2.7,b1=.05), verbose=T, groups=~state, control=nlmeControl(msMaxIter=500,opt="nlminb",pnlsTol=.0001,msVerbose=T,minScale=.0001, maxIter=200) )
```
...
$$
\bigg[\frac{a}{\kappa_1 (1+\exp^{2(\kappa_0 + \kappa_1 t)} )}\bigg] \;\;\; \bigg[(\exp^{2(\kappa_0 + \kappa_1 t)} - 1)\bigg] + C
$$
