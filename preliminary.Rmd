...
#coupled with linewidth=xx argument to chunk will make R code fit within the width of the page
...
#cache=F to redo the lengthy analyses for new data, otherwise set to T for daily runs
cache <- T
```
