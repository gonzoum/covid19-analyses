...
options(htmltools.dir.version = FALSE, formatR.indent = 2, 
        width = linewidth, digits = 3)

opts_chunk$set(tidy.opts=list(width.cutoff=linewidth),tidy=TRUE)
...
```{r eval=F, echo=longform, linewidth=linewidth}
