...
Here I separate installing on PC and Mac.  There are some issues that occur on each platform. For more information see the webpage [Git Hell](https://stat545-ubc.github.io/git66_rstudio-git-github-hell.html)
...
Some things to check include running git config -l to see your local configuration;  you may need to set username and email typing the following commands in the shell. 

git config --global user.name "John Doe"

git config --global user.email johndoe@example.com

Other solutions that worked in the past include manually pulling the repository and there after Rstudio Git works fine. 
